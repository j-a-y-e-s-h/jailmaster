...
from gui.main_window.prison_allocate.main import PrisonAllocate
from gui.main_window.about.main import About
from gui.main_window.prisons.main import PrisonCell
from gui.main_window.prisoners.main import Prisoners
from .. import login
...
class MainWindow(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("JailMaster - Pride Of Jailer ")
        ...
        self.prisons_cell_btn = Button(
            self.canvas,
            image=button_image_2,
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.handle_btn_press(self.prisons_cell_btn, "prc"),
            cursor='hand2', activebackground="#5E95FF",
            relief="flat",
        )
        self.prisons_cell_btn.place(x=7.0, y=183.0, width=208.0, height=47.0)

        button_image_3 = PhotoImage(file=relative_to_assets("button_3.png"))
        self.prisoners_btn = Button(
            self.canvas,
            image=button_image_3,
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.handle_btn_press(self.prisoners_btn, "prnr"),
            cursor='hand2', activebackground="#5E95FF",
            relief="flat",
        )
        self.prisoners_btn.place(x=7.0, y=283.0, width=208.0, height=47.0)
        ...
        self.prison_allocate_btn = Button(
            self.canvas,
            image=button_image_6,
            borderwidth=0,
            highlightthickness=0,
            command=lambda: self.handle_btn_press(self.prison_allocate_btn, "pral"),
            cursor='hand2', activebackground="#5E95FF",
            relief="flat",
        )
        self.prison_allocate_btn.place(x=7.0, y=233.0, width=208.0, height=47.0)
