...
class ViewPrisoners(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.columns = {
            "Prisoners ID": ["Prisoners ID", 30],
            "Name": ["Name", 80],
            "Address": ["Address", 100],
            "Sections": ["Sections", 250],
            "Other Details": ["Other Details", 250],
    ...
    def filter_treeview_records(self, query):
        ...
        for row in self.prisoners_data:
    ...
    def handle_delete(self):
        if db_controller.delete_prisoners(self.parent.selected_rid):
            messagebox.showinfo("Successfully Deleted the Prisoners")
        else:
            messagebox.showerror("Unable to delete Prisoners")
