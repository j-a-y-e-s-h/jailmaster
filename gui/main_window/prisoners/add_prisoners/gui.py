...
class AddPrisoners(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        entry_2 = Entry(
            self,
            textvariable=self.data.get("Other Details"),
            font=("Montserrat Bold", 18 * -1),
            foreground="#777777",
            bd=0,
            bg="#EFEFEF",
        ...
        entry_4 = Entry(
            self,
            textvariable=self.data.get("Sections"),
            font=("Montserrat Bold", 18 * -1),
            foreground="#777777",
            bd=0,
            bg="#EFEFEF",
    ...
    def save(self):
        ...
        # Save the prisoners
        result = db_controller.add_prisoners(
            *[self.data[label].get() for label in ("name", "address", "Sections", "Other Details")]
        )

        if result:
            messagebox.showinfo("Success", "prisoners added successfully")
            ...
            messagebox.showerror(
                "Error", "Unable to add prisoners. Please make sure the data is validated"
            )
