...
def add_prison_allocate():
    AddPrisonAllocate()


class AddPrisonAllocate(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        Frame.__init__(self, parent, *args, **kwargs)
        self.parent = parent
        self.data = {"p_id": "", "allocate": "", "Supplies": "", "p_c_a_id": ""}
        ...
        self.data["allocate"].insert(0, "now")
    ...
    def save(self):
        ...
        # Save the Prison Allocate
        result = db_controller.add_prison_allocate(
            *[self.data[label].get() for label in ("p_id", "Supplies", "p_c_a_id", "allocate")]
        )

        if result:
            messagebox.showinfo("Success", "Allocate Prison successfully")
            ...
            messagebox.showerror(
                "Error",
                "Unable to Allocate Prison. Please make sure the data is validated",
            )
