...
def view_prison_cell():
    ViewPrisonCell()


class ViewPrisonCell(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.columns = {
            "prison cell ID": ["prison cell ID", 100],
            "Number": ["Number", 80],
            "Type": ["Type", 100],
            "charges": ["charges", 150],
    ...
    def filter_treeview_records(self, query):
        ...
        for row in self.prisons_cell_data:
    ...
    def handle_refresh(self):
        self.treeview.delete(*self.treeview.get_children())
        self.prisons_cell_data = db_controller.get_prison_cell()
        for row in self.prisons_cell_data:
            self.treeview.insert("", "end", values=row)
    ...
    def handle_delete(self):
        if db_controller.delete_prison_cell(self.parent.selected_pca_id):
            messagebox.showinfo("Successfully Deleted the prison cell")
        else:
            messagebox.showerror("Unable to delete prison cell")
