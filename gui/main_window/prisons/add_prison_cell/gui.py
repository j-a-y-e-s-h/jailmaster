...
class AddPrisonCell(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        Frame.__init__(self, parent, *args, **kwargs)
        self.parent = parent
        self.data = {"c_no": StringVar(), "type": StringVar(), "charges": StringVar()}
    ...
    def save(self):
        ...
        # Save the Prison Cell
        result = db_controller.add_prison_cell(
            *[self.data[label].get() for label in ("c_no", "charges", "type")]
        )

        if result:
            messagebox.showinfo("Success", "Prison Cell added successfully")
            ...
            messagebox.showerror(
                "Error", "Unable to add Prison Cell. Please make sure the data is validated"
            )
