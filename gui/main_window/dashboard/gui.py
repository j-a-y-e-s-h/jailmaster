...
class Dashboard(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        canvas.create_text(
            ...
            63.0,
            anchor="ne",
            text=db_controller.get_total_charges(),
            fill="#5E95FF",
            font=("Montserrat Bold", 48 * -1),
        )
        ...
        plot1.pie(
            [db_controller.vacant(), db_controller.allocated()],
            [0.1, 0.1],
            startangle=-30,
